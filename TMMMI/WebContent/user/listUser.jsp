										...
										<tr>
											...
											<c:choose>
												<c:when test="${user.withdrawCheck eq 1 }">
													...
													<td align="center"><button type="button" class="btn btn-warning btn-round" id="withdrawCancle${user.userNo }" data-withdrawcancle="${user.userNo }">복구</button></td>
												</c:when> 
												<c:otherwise>
													<td align="center" style="padding:25px;"></td>
													<td align="center"><button type="button" class="btn btn-info btn-round" id="withdraw${user.userNo }" data-withdraw="${user.userNo }">탈퇴</button></td>
												</c:otherwise>
											</c:choose>
