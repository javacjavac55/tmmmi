								...
								<div class="container">
									<form name="detailForm" class="form-inline ml-auto">
										<div class="form-group bmd-form-group" style="align-content: right;">
											<input type="text" class="form-control" id="searchKeyword" name="searchKeyword" placeholder="아이디" value="${! empty search.searchKeyword ? search.searchKeyword : '' }">
											<input type="hidden" id="currentPage" name="currentPage"  value="" />
										</div>
										...
										<tr>
											...
											<c:choose>
												<c:when test="${user.withdrawCheck eq 1 }">
													...
													<td align="center"><span id="helf${user.userNo }"></span><button type="button" class="btn btn-warning btn-round" id="withdrawCancle${user.userNo }" data-withdrawcancle="${user.userNo }">복구</button></td>
												</c:when> 
												<c:otherwise>
													<td align="center" style="padding:25px;"></td>
													<td align="center"><span id="helf${user.userNo }"></span><button type="button" class="btn btn-info btn-round" id="withdraw${user.userNo }" data-withdraw="${user.userNo }">탈퇴</button></td>
												</c:otherwise>
											</c:choose>
