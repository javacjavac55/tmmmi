    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand">
          	<h2 class="title" style="font-family: 맑은 고딕;">1:1 문의하기</h2>
          	<h3 class="title" style="margin-top:-2%; font-family: 맑은 고딕;">무엇을 도와드릴까요?</h3>
          </div>
        </div>
      </div>
    </div>
			...
			<div class="form-group row">
				<div class="col-md-6">
			 	...
			 	<div class="form-group col-md-6" style="margin-top: 0.67%;">
				    <label style="color:#9c27b0!important; margin-left: 3.5%;">회원아이디</label>
