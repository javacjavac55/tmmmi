...
<body>
	<section class="carousel">
		<div><span class="section-title">해외 축구</span></div>
	...
	<script>
		...
		$(function() {
			...
			$(document).on('click', '.forward', function(){
				...
				if (more) {
					$.ajax({
						url : "/contentSportRest/getContentWsoccerList?index="+count,
						method : "GET",
						dataType: "json",
						headers : {
						...
						success : function(JSONData, status) {
							...
							if (JSONData.length==0) {
								...
								refresh();
								bind();
								parent.bind('ContentWsoccerList');
							}
						}
					});
				}
