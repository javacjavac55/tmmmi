...
<body>
	<section class="carousel">
		<div><span class="section-title">${userVideoFirstList[0].keywordLink}</span></div>
		<div class="reel" style="overflow: visible; transform: translate(-1285px, 0px); ">
			...
			<input type="hidden" value="${userVideoFirstList[0].keywordNextToken}" id="pageToken">
		</div>
	</section>		
	<!-- Carousel JS -->
		...
		$(function(){
			$(document).on('click', '.play-btn', function(){
				...
				$(document).on('click', '.forward', function(){			
					...
					if (more) {
						$.ajax({
							url : "/contentKeywordRest/getUserVideoListFirst?index="+count+"&pageToken="+pageToken,
							method : "GET",
							dataType: "json",
							headers : {
