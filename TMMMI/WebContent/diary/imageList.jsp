...
<script type="text/javascript">
   ...
   $(function() {
      $(".material-icons").on("onmouseover", function() {
         console.log('on');
                           ...
                           <c:forEach var="diary" items="${list}">
                              <c:set var="i" value="${ i+1 }" />
                                  ...
                                  <figure class="card" style="cursor:pointer;">
                                     <input type="hidden" id="diaryNo" name="deleteImage" value="${diary.diaryNo}" />
                                     <button type="button" class="close" data-param2="${diary.diaryNo}">
