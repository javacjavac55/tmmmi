...
<body>
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu-calendarType">
                    <li role="presentation">
                        <a class="dropdown-menu-title" role="menuitem" data-action="toggle-daily">
                            <img src="/images/tui/image/ic-view-day.png" class="calendar-icon ic_view_week"/>Daily
                        </a>
                    </li>
                    <li role="presentation">
    ...
    <script src="/javascript/tui/tui-calendar.js"></script>
    <script src="/javascript/tui/data/userCategory.js"></script>
    <script src="/javascript/tui/data/schedules.js"></script>
    <script src="/javascript/tui/theme/dooray.js"></script>
    <script src="/javascript/tui/default.js"></script>
</body>
</html>