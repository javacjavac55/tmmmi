...
public class ContentSportDaoImpl implements ContentDao {
	...
	private String address = "https://sports.news.naver.com/wfootball/index.nhn";
	...
	public List<Object> getContentList(ContentSetting contentSetting, int index) throws Exception{
		...
		for(int i=start; i<20; i++) {
			...
			//subAddress= (((element.toString().split("target")[0]).split("href=")[1]).replaceAll("amp;", "")).replaceAll("\"", "");
			...
			//contentSport.setSportThumbnail((((element3.toString()).split("\" alt=")[0]).replaceAll("src=\"data:", "")).split("src=\"")[1]);
