...
import com.tmmmi.service.user.GoogleDao;
@Repository("googleDaoImpl")
public class GoogleDaoImpl  implements GoogleDao{

		private final static String CLIENT_ID = "870466369858-rokum2pspv4jfp4ru8fu112ofc90aq45.apps.googleusercontent.com";
		private final static String CLIENT_SECRET ="uQXZA0AKE4hpmuQUgDKVfNIP";
		private final static String SCOPE = "https://www.googleapis.com/auth/plus.login";
		private final static String REDIRECT_URI = "http://127.0.0.1:8080/SNSLogin/googleLogin";
